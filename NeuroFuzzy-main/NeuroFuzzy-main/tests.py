...
print(round(anf.consequents[-1][0], 7))
print(round(anf.consequents[-2][0], 7))
print(round(anf.fittedValues[9][0], 7))
if round(anf.consequents[-1][0], 7) == -5.275538 and round(anf.consequents[-2][0], 6) == -1.990703 and round(anf.fittedValues[9][0], 6) == 0.002249:
    print('Test is good')
